local ThemeManager = {} do
	ThemeManager.Folder 				= "Crypt/Themes"
	ThemeManager.Library			 	= nil
	ThemeManager.BuiltInThemes			= {
		["Default"] 					= { 1, Crypt.Services.HttpService:JSONDecode('{"FontColor":"ffffff","MainColor":"181b25","AccentColor":"448fe3","BackgroundColor":"16191f","OutlineColor":"323232"}') },
		["BBot"] 						= { 2, Crypt.Services.HttpService:JSONDecode('{"FontColor":"ffffff","MainColor":"1e1e1e","AccentColor":"7e48a3","BackgroundColor":"232323","OutlineColor":"141414"}') },
		["Fatality"]					= { 3, Crypt.Services.HttpService:JSONDecode('{"FontColor":"ffffff","MainColor":"1e1842","AccentColor":"c50754","BackgroundColor":"191335","OutlineColor":"3c355d"}') },
		["Jester"] 						= { 4, Crypt.Services.HttpService:JSONDecode('{"FontColor":"ffffff","MainColor":"242424","AccentColor":"db4467","BackgroundColor":"1c1c1c","OutlineColor":"373737"}') },
		["Mint"] 						= { 5, Crypt.Services.HttpService:JSONDecode('{"FontColor":"ffffff","MainColor":"242424","AccentColor":"3db488","BackgroundColor":"1c1c1c","OutlineColor":"373737"}') },
		["Tokyo Night"] 				= { 6, Crypt.Services.HttpService:JSONDecode('{"FontColor":"ffffff","MainColor":"191925","AccentColor":"6759b3","BackgroundColor":"16161f","OutlineColor":"323232"}') },
		["Ubuntu"] 						= { 7, Crypt.Services.HttpService:JSONDecode('{"FontColor":"ffffff","MainColor":"3e3e3e","AccentColor":"e2581e","BackgroundColor":"323232","OutlineColor":"191919"}') },
		["Quartz"] 						= { 8, Crypt.Services.HttpService:JSONDecode('{"FontColor":"ffffff","MainColor":"232330","AccentColor":"426e87","BackgroundColor":"1d1b26","OutlineColor":"27232f"}') },
	}
	...
	function ThemeManager:GetCustomTheme(Name)
		...
		local Success, Decoded 			= pcall(Crypt.Services.HttpService.JSONDecode, Crypt.Services.HttpService, Data)
	...
	function ThemeManager:OverrideCustomTheme(Name)
		...
		writefile(string.format("%s/%s.json", self.Folder, Name), Crypt.Services.HttpService:JSONEncode(Theme))
